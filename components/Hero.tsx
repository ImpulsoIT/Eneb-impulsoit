...
export const Hero: React.FC<HeroProps> = ({ onCtaClick }) => {
  return (
    <section className="relative bg-[#0a0a0a] text-white pt-6 pb-12 md:pt-12 md:pb-20 lg:pt-16 lg:pb-32 overflow-hidden min-h-[85vh] flex items-center">
      {/* Fondos dinámicos y efectos visuales */}
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          {/* Matrículas Abiertas y Monedas */}
          <div className="inline-flex items-center bg-white/5 backdrop-blur-md border border-white/10 text-white text-[9px] sm:text-[10px] font-black px-4 py-2 rounded-full mb-5 tracking-[0.15em] uppercase animate-fade-in-up">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl xl:text-8xl font-black leading-[0.95] mb-5 tracking-tighter animate-fade-in-up">
            Tu Título <br />
          ...
          {/* Descripción con énfasis en Beca y Moneda Local */}
          <p className="text-sm sm:text-lg md:text-xl text-gray-400 mb-8 max-w-2xl font-medium leading-tight animate-fade-in-up delay-100">
        ...
        {/* Lado Derecho: Imagen y Card de Superposición */}
        <div className="w-full lg:w-2/5 relative animate-fade-in-up delay-300 mt-8 lg:mt-0">
          <div className="relative animate-float mx-auto max-w-[340px] sm:max-w-[420px] lg:max-w-none">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl group">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                 <div className="bg-white/5 backdrop-blur-xl p-5 rounded-2xl border border-white/10 text-center">
                    ...
                    <p className="text-[9px] font-black uppercase text-impulsoPink tracking-[0.2em]">Formación ejecutiva global ImpulsoIT</p>
                 </div>
              </div>
            </div>
            
            {/* Elemento de Status Superpuesto */}
            <div className="absolute -top-5 -right-5 bg-white p-4 rounded-2xl shadow-2xl hidden md:block border border-gray-100 rotate-2 hover:rotate-0 transition-transform cursor-default z-20">
               <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Status Actual</p>
               <p className="text-[11px] font-black text-enebGrey flex items-center">
