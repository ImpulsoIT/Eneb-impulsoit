             ...
             <div className="relative group max-w-md mx-auto lg:max-w-none">
               ...
               <div className="absolute -bottom-6 right-4 sm:-right-6 lg:-right-12 bg-white p-6 sm:p-8 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-gray-50 transform group-hover:translate-y-[-10px] transition-transform duration-500 max-w-[220px] sm:max-w-[280px]">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <p className="text-[9px] font-black text-impulsoPink uppercase tracking-tighter">Formación Actual</p>
                      <p className="text-xs sm:text-sm font-black text-enebGrey">Máster + PDD en IA</p>
                    </div>
                  </div>
             ...
             <div className="space-y-6 text-gray-500 font-medium leading-relaxed">
               ...
               <div className="grid grid-cols-2 gap-4 my-8">
                 <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-center sm:text-left">
                    ...
                    <p className="text-[9px] sm:text-[10px] font-bold text-gray-400 uppercase">Online & Flexible</p>
                 </div>
                 <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-center sm:text-left">
                    <p className="text-xl sm:text-2xl font-black text-enebGrey">Doble</p>
                    <p className="text-[9px] sm:text-[10px] font-bold text-gray-400 uppercase">Titulación Europea</p>
                 </div>
               </div>
               
               <div className="relative p-6 sm:p-8 bg-[#0a0a0a] rounded-[2rem] overflow-hidden group">
                 ...
                 <p className="italic relative z-10 text-white font-medium text-base sm:text-lg">
                   "Mi meta es que tú también aproveches esta oportunidad. Si tienes dudas sobre mi experiencia real, estoy aquí para guiarte."
                 </p>
               </div>
               ...
               <div className="pt-8 flex justify-center lg:justify-start">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <p className="text-xs sm:text-sm font-black text-enebGrey group-hover:text-impulsoPink transition-colors">¿Hablamos por WhatsApp?</p>
                      <p className="text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-widest">Te asesoro personalmente</p>
                    </div>
                  </button>
               </div>
             </div>
