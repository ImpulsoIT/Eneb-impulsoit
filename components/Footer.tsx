  ...
  return (
    <footer className="bg-[#0a0a0a] text-white pt-20 pb-10 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="text-gray-500 text-sm space-y-4 font-semibold">
              <li><a href="#" className="hover:text-impulsoPink transition-colors">MBA - Business Administration</a></li>
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Dirección de RRHH</a></li>
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Digital Marketing</a></li>
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Corporate Finance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-500 text-sm space-y-4 font-semibold">
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Nuestro Rol</a></li>
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Becas Exclusivas</a></li>
              <li><a href="#" className="hover:text-impulsoPink transition-colors">Soporte al Alumno</a></li>
          ...
          <div>
            ...
            <ul className="text-gray-500 text-sm space-y-4 font-semibold">
              ...
              <li className="flex items-center">
                ...
                contacto@impulsoit.es
              </li>
              <li className="text-white font-black text-lg mt-4">
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-600 font-bold uppercase tracking-widest">
